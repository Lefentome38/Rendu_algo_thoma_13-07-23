...
exports.Rendu_du_brief_thoma_A = void 0;
const Rendu_du_brief_thoma_A = () => {
    ...
    function sumDices(des) {
        ...
        for (let index = 0; index < des.length; index++) {
            ...
            if (element === "vert") {
                ...
                sum = sum +
                ; //la somme des dés blanc 1+1 vert+violet
            }
        }
        return sum;
    }
...
exports.Rendu_du_brief_thoma_A = Rendu_du_brief_thoma_A;
